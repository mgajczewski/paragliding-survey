  ...
  root((Survey Categories))
    Solution 1: Equalizers
      Concerns
        ...
        Safety/Installation
        Unfairness
        Unfairness (performance gap)
        Safety (light pilots ballasting)
        Market (incentives for small wings)
        Market Stagnation
        Technological Stagnation
        Philosophy (adding drag)
        Gaming the system
        Logistics
      Benefits
        Levels the field
        Improves Safety
        Promotes small wings
        Promotes micro sizes
        Promotes intermediate sizes
        Keeps "Overall" ranking
        Fairness
        Simple to Implement
    Solution 2: Partial Weight Class
      Concerns
        Dilutes "Overall" Title
        Safety (incomplete solution)
      ...
      Benefits
        ...
        Simple to Implement
        Simple to Verify
        Preserves "Overall" Winner
        Preserves Ranking
    Solution 3: Comprehensive Weight Classes
      Concerns
        Loses "Overall" Winner
        Community Fragmentation
        Diluted Competition
        Devalues Titles
        Logistics
    ...
    Solution 5: MRT
      Concerns
        Tactical Complexity
        Disrupts Gaggle Flying
        Task Setter Dependency
        Safety (crossing tracks)
    ...
    Solution 6: Hybrid System
      Concerns
        Dilutes Competition
        Community Fragmentation
        Too Complicated
        Devalues "Champion" Title
        Resource Intensive
      Benefits
        Pilot Choice
        Solves the Problem for Those Who Want It
...
*   **Safety**
    ...
    *   *Examples*: `Improves Safety`, `Safety/Certification`, `Safety/Installation`, `Safety (light pilots ballasting)`, `Safety (incomplete solution)`, `Ineffective on Safety (ballast)`, `Safety (crossing tracks)`.

*   **Fairness & Equality**
    *   *Description*: How a solution impacts the level playing field for pilots of different weights.
    *   *Examples*: `Levels the field`, `Maximizes Fairness`, `Unfairness`, `Unfairness (performance gap)`, `Unfairness (doesn't solve disparity)`, `Fairness (addresses performance gap)`, `Task Setter Dependency`.
...
*   **Implementation & Logistics**
    ...
    *   *Examples*: `Simple to Implement`, `Logistics`, `Enforcement`, `Resource Intensive`, `Complexity (opaque formula)`.
...
*   **Community & Pilot Experience**
    ...
    *   *Examples*: `Community Fragmentation`, `Pilot Choice`, `Tactical Complexity`, `Disrupts Gaggle Flying`, `Spectator Unfriendly`.
